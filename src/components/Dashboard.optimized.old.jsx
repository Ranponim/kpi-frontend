...
const Dashboard = () => {
  ...
  useEffect(() => {
    console.log(
      "[Dashboard] enableTimeComparison 상태 변경:",
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={updateDefaultTimeRange}
            >
              <SelectTrigger>
      ...
      >
        <DialogContent className="max-w-6xl">
          ...
          <div className="h-[480px]">
            {Array.isArray(zoomed.data) &&
              zoomed.data.length > 0 &&
              renderChart(zoomed.data, "zoom", 0)}
          </div>
        </DialogContent>
      </Dialog>
