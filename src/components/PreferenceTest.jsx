      ...
      <div className="space-y-6">
        <div className="border-t pt-6">
          ...
          <p className="text-muted-foreground mb-6">
            실제 SettingBox 컴포넌트를 사용하여 설정을 관리해보세요. 변경사항은
            자동으로 저장되며 유효성 검증이 실시간으로 적용됩니다.
          </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              📄 Import/Export 기능은 위의 "설정 백업 & 복원" 박스에서 테스트할
              수 있습니다.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <div className="text-sm space-y-1">
                <div>
                  <strong>선택된 PEGs:</strong>{" "}
                  {dashboardSettings.selectedPegs?.join(", ")}
                </div>
                <div>
                  <strong>기본 NE:</strong>{" "}
                  {dashboardSettings.defaultNe || "없음"}
                </div>
                <div>
                  <strong>기본 Cell ID:</strong>{" "}
                  {dashboardSettings.defaultCellId || "없음"}
                </div>
                <div>
                  <strong>자동 새로고침:</strong>{" "}
                  {dashboardSettings.autoRefreshInterval}초
                </div>
              </div>
            </div>
            ...
            <div className="text-xs text-muted-foreground">
              <div>
                ...
                {lastSaved ? lastSaved.toLocaleTimeString() : "없음"}
              </div>
              <div>
                <strong>저장되지 않은 변경사항:</strong>{" "}
                {hasUnsavedChanges ? "있음" : "없음"}
              </div>
            </div>
          </CardContent>
        </Card>
